...
export function Hero() {
  ...
  return (
    <section id="top" className="bg-white pt-[60px]">
      {/* Top bar orange */}
      <div className="bg-[#E63946] py-2 px-4 text-center text-white text-sm font-semibold">
      ...
      <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-12 gap-8 lg:gap-10 items-start py-8 md:py-10">
        ...
        <div className="lg:col-span-7">
          <p className="text-[#1E3A5F] font-semibold text-sm uppercase tracking-wide mb-2">
          ...
          <a href="tel:0756950273" className="inline-flex items-center gap-3 mb-5 group">
            <span className="flex items-center justify-center w-11 h-11 rounded-full bg-[#1E3A5F] text-white group-hover:bg-[#163050] transition-colors shrink-0">
              <Phone className="w-5 h-5" strokeWidth={2.5} />
            </span>
            <div>
              <div className="text-[#1E3A5F] font-extrabold text-2xl leading-none">07 56 95 02 73</div>
          ...
          <ul className="space-y-2">
            {[
              ...
              <li key={i} className="flex items-center gap-2.5 text-sm text-[#444444]">
                <Icon className="w-4 h-4 text-[#1E3A5F] shrink-0" strokeWidth={2} />
                {text}
              </li>
            ))}
          </ul>
        ...
        <div className="lg:col-span-5 bg-[#1E3A5F] rounded-lg p-6 text-white shadow-md">
          {sent ? (
            ...
            <>
              ...
              <form onSubmit={onSubmit} className="space-y-2">
                ...
                <button
                  type="submit"
                  className="w-full bg-white text-[#1E3A5F] font-bold py-2.5 rounded text-sm hover:bg-[#f9f9f9] transition-colors mt-1"
                >
